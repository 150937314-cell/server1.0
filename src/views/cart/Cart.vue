       ...
       computed:{ 
           ...mapState(["shopCart","userInfo"]),
            ...
            isSelectedAll(){
               ...
               totalPrice(){
                    let prices=0;
                    Object.values(this.shopCart).forEach((obj)=>{
                        if(obj.checked){
         ...
         methods: {
             ...mapMutations(["REDUCE_CART","ADD_GOODS","SELECTER_SINGER_GOODS","SELECTER_ALL_GOODS","CLEAR_GOODS"]),
        //移除购物车
            ...
            //2.增加商品
            addCart(goodsId, goodsName, smallImage, goodsPrice){
                this.ADD_GOODS({
                    goodsId,
                    goodsName,
                    smallImage,
            ...
            singerGoodsSelected(goodsId){ 
                this.SELECTER_SINGER_GOODS({goodsId})
            },
             //4.全选和全取消
            selectedAll(isSelected){ 
                this.SELECTER_ALL_GOODS({isSelected})  
            },
            //6.清空购物车
            clearAll(){
                Dialog.confirm({
